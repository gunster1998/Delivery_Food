        ...
        >
          ...
          <div class="products-cart_description">
            <div class="products-cart_description-row">
              <h4 class="products-cart_description-title">{{ rest.title }}</h4>
              <div class="products-cart_description-bage">{{ rest.time }} мин</div>
            </div>
            <div class="products-cart_description-row">
              <div class="products-cart_description-info">
                ...
                <div class="products-cart_description-price">От {{ rest.price }} ₽</div>
                <div class="products-cart_description-group">{{ rest.type }}</div>
              </div>
            </div>
          </div>
        </router-link>
...
const getUrl = (name) => {
  return new URL(`../assets/img/restaurant/${name}`, import.meta.url)
}
